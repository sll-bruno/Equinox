...
The 2026 pilot was adverse to spot but did not meaningfully test the short-perp margin account. This window begins with mark price US$26,953.50; the always-on short executes one hour later at US$26,976.50 and the mark reaches US$73,655.72 on 2024-03-14 06:00 UTC, a +173.04% maximum adverse excursion from the executable entry. It also contains a +13.87% maximum 24-hour mark rise and a -18.40% maximum 24-hour mark fall, plus 95 negative-funding settlements out of 1,008. It is materially different from the original pilot's +0.4% worst short-adverse move.

## Result: the margin policy is breached

Under the explicitly simplified 5% maintenance rule, the approximate no-funding thresholds including perp entry and estimated close fees are mark rises of 18.93%, 42.73%, or 90.32% for the 25%, 50%, or 100% buffer respectively. The full simulation also credits `q × mark × fundingRate`, so actual breach timing can differ from those closed forms. The historical maximum of +173.04% from the executable entry crossed every threshold. Always-on recorded one simulated violation at each buffer and closed both legs at the following executable hourly open:
...
| 100% | 2024-02-26 19:00 UTC | 44.27% |
