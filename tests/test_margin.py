...
from src.run_baselines import make_ledger_from_position, position_from_signal
...
def test_buffer_is_consumed_when_btc_rises_and_grows_when_it_falls():
    ...
    assert rising.margin_balance_usdt.iloc[2] == 30.0
    assert falling.margin_balance_usdt.iloc[2] == 70.0
